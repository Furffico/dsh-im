...
var EN = Object.freeze({
  ...
  "\u65B0\u5EFA\u4F1A\u8BDD\u6CBF\u7528 Host Settings \u91CC\u7684 permission \u9ED8\u8BA4\u503C\u3002": "New sessions keep the permission default from Host Settings.",
  "\u5DE5\u4F5C\u533A\u5185\u53EF\u5199\uFF0C\u66F4\u5BBD\u6743\u9650\u9700\u8981\u5BA1\u6279\u3002": "Writable inside the workspace; wider access requires approval.",
  "\u65E0\u6587\u4EF6\u6C99\u7BB1\u9650\u5236\uFF0C\u4E5F\u4E0D\u5F39\u51FA\u5BA1\u6279\u3002": "No file-sandbox restriction and no approval prompts.",
  "\u4E0D\u8986\u76D6 Host Settings \u7684 permission \u9ED8\u8BA4\u503C\u3002": "Does not override the permission default from Host Settings.",
  "\u5BF9\u5E94 /permission workspace-write\u3002": "Maps to /permission workspace-write.",
  "\u5BF9\u5E94 /permission danger-full-access\u3002\u53EA\u5F71\u54CD\u65B0\u5EFA\u4F1A\u8BDD\uFF1B\u5DF2\u6709\u4F1A\u8BDD\u53D1\u9001 /new \u540E\u518D\u53D1\u666E\u901A\u6D88\u606F\u624D\u4F1A\u751F\u6548\u3002": "Maps to /permission danger-full-access. This affects only new sessions. If the current chat already has a session, send /new, then send a regular message to apply it.",
  "\u8BF7\u9009\u62E9\u300C\u8DDF\u968F Host \u9ED8\u8BA4\u300D\u3001\u300CWorkspace Write\u300D\u6216\u300CFull access\u300D\u3002": "Choose Follow the Host default, Workspace Write, or Full access.",
  "Discord \u8D26\u53F7\u8BBE\u7F6E\u6682\u4E0D\u53EF\u7528\u3002": "Discord account settings are unavailable.",
  "Discord \u8D26\u53F7\u8BBE\u7F6E\u4FDD\u5B58\u5931\u8D25\u3002": "Could not save Discord account settings.",
  "\u4FDD\u5B58\u8BBE\u7F6E": "Save settings",
  "\u8BF7\u9009\u62E9\u7FA4\u54CD\u5E94\u6A21\u5F0F\uFF0C\u4EE5\u53CA\u300C\u8DDF\u968F Host \u9ED8\u8BA4\u300D\u3001\u300CWorkspace Write\u300D\u6216\u300CFull access\u300D\u3002": "Choose a group response mode and Follow the Host default, Workspace Write, or Full access.",
...
// src/channels/discord/group-response-mode.mjs
var DISCORD_GROUP_RESPONSE_MODES = Object.freeze({
  THREAD: "thread",
  CHANNEL: "channel"
});
var DEFAULT_DISCORD_GROUP_RESPONSE_MODE = DISCORD_GROUP_RESPONSE_MODES.THREAD;
function normalizeDiscordGroupResponseMode(value) {
  return value === DISCORD_GROUP_RESPONSE_MODES.CHANNEL ? DISCORD_GROUP_RESPONSE_MODES.CHANNEL : DEFAULT_DISCORD_GROUP_RESPONSE_MODE;
}

// src/channels/discord/session-permission.mjs
var DISCORD_SESSION_PERMISSIONS = Object.freeze({
  WORKSPACE_WRITE: "workspace-write",
  DANGER_FULL_ACCESS: "danger-full-access"
});
var DISCORD_SESSION_PERMISSION_VALUES = Object.freeze(
  Object.values(DISCORD_SESSION_PERMISSIONS)
);
function isDiscordSessionPermission(value) {
  return value === DISCORD_SESSION_PERMISSIONS.WORKSPACE_WRITE || value === DISCORD_SESSION_PERMISSIONS.DANGER_FULL_ACCESS;
}
function normalizeDiscordSessionPermission(value) {
...
var DISCORD_ENDPOINTS = Object.freeze({
  ...TOKEN_BOT_ENDPOINTS,
...
var api = createTokenChannelApi("Discord", " Gateway \u957F\u8FDE\u63A5", {
  normalizeBotExtension: (value) => {
    ...
    const groupResponseMode = source === DISCORD_GROUP_RESPONSE_MODES.CHANNEL ? DISCORD_GROUP_RESPONSE_MODES.CHANNEL : DISCORD_GROUP_RESPONSE_MODES.THREAD;
    return {
      groupResponseMode,
...
// plugin-src/client/channels/discord/account-settings.js
...
function DiscordAccountSettings({ account, busy = false, onSave }) {
  const currentMode = modeFor(account);
  const currentPermission = permissionFor(account);
  const modeHelpId = React12.useId();
  const permissionHelpId = React12.useId();
  const [selectedMode, setSelectedMode] = React12.useState(currentMode);
  const [selectedPermission, setSelectedPermission] = React12.useState(currentPermission);
  ...
  return h2(
    "form",
    { className: "ddc-group", onSubmit: save },
    h2(
      "div",
      { className: "ddc-groupHeading" },
      h2("strong", null, "\u7FA4\u54CD\u5E94\u6A21\u5F0F"),
      h2(
        "span",
        { className: "ddc-groupStatus" },
        h2(
          "span",
          { className: "ddc-groupBadge", "data-mode": currentMode },
          currentMode === DISCORD_GROUP_RESPONSE_MODES.CHANNEL ? "\u5DF2\u751F\u6548\uFF1A\u9891\u9053\u76F4\u63A5\u56DE\u590D" : "\u5DF2\u751F\u6548\uFF1A\u7EBF\u7A0B\u6A21\u5F0F"
        ),
        h2(
          "span",
          { className: "ddc-groupHelp" },
          h2("button", {
            type: "button",
          ...
          h2(
            ...
            h2(
              "span",
              { className: "ddc-groupTooltipItem" },
              h2("strong", null, "\u7EBF\u7A0B\u6A21\u5F0F\uFF08\u9ED8\u8BA4\uFF09"),
              h2("span", null, "\u5728\u88AB @ \u65F6\u4E3A\u672C\u6B21\u5BF9\u8BDD\u81EA\u52A8\u521B\u5EFA Thread,\u540E\u7EED\u56DE\u590D\u90FD\u5728 Thread \u5185,\u907F\u514D\u9891\u9053\u88AB\u591A\u4EBA\u5BF9\u8BDD\u5237\u5C4F\u3002")
            ),
            h2(
              "span",
              { className: "ddc-groupTooltipItem" },
              h2("strong", null, "\u9891\u9053\u76F4\u63A5\u56DE\u590D"),
              h2("span", null, "\u4FDD\u6301 v0.16.0 \u53CA\u66F4\u65E9\u7248\u672C\u7684\u65E7\u884C\u4E3A:\u5728\u88AB @ \u65F6\u76F4\u63A5\u5728\u6E90\u9891\u9053\u91CC reply \u4E3B\u6D88\u606F,\u7EBF\u7A0B\u4E0D\u4F1A\u88AB\u521B\u5EFA\u3002")
            )
          )
        )
      )
    ...
    h2(
      "div",
      { className: "ddc-groupField", role: "radiogroup", "aria-label": "Discord \u7FA4\u54CD\u5E94\u6A21\u5F0F" },
      MODE_OPTIONS.map((option) => h2(
        "label",
        {
          key: option.value,
        ...
        h2(
          "span",
          { className: "ddc-groupOptionBody" },
          h2("strong", null, option.title),
          h2("small", null, option.description)
        )
      ))
    ),
    h2(
        ...
        h2(
          ...
          h2(
            ...
            h2(
              "span",
              { className: "ddc-groupTooltipItem" },
              h2("strong", null, "\u8DDF\u968F Host \u9ED8\u8BA4"),
              h2("span", null, "\u4E0D\u8986\u76D6 Host Settings \u7684 permission \u9ED8\u8BA4\u503C\u3002")
            ),
            h2(
              "span",
              { className: "ddc-groupTooltipItem" },
              h2("strong", null, "Workspace Write"),
              h2("span", null, "\u5BF9\u5E94 /permission workspace-write\u3002")
            ),
            h2(
              "span",
              { className: "ddc-groupTooltipItem" },
              h2("strong", null, "Full access"),
              h2("span", null, "\u5BF9\u5E94 /permission danger-full-access\u3002\u53EA\u5F71\u54CD\u65B0\u5EFA\u4F1A\u8BDD\uFF1B\u5DF2\u6709\u4F1A\u8BDD\u53D1\u9001 /new \u540E\u518D\u53D1\u666E\u901A\u6D88\u606F\u624D\u4F1A\u751F\u6548\u3002")
            )
          )
        )
      )
    ...
    h2(
      "div",
      { className: "ddc-groupField", role: "radiogroup", "aria-label": "Discord \u65B0\u5EFA\u4F1A\u8BDD\u6743\u9650" },
      PERMISSION_OPTIONS.map((option) => h2(
        "label",
        {
    ...
    error ? h2("p", { className: "ddc-groupError", role: "alert" }, error) : null,
    h2(
      "div",
      { className: "ddc-groupActions" },
      h2("button", {
        type: "submit",
        className: "ddt-button",
        "data-kind": "secondary",
...
function GroupResponseModeEditor({
  ...
  const [authorizing, setAuthorizing] = React14.useState(false);
...
function FeishuSettingsTab({ rpcCall }) {
  ...
  const authorizeGroupMessages = React14.useCallback(async (connection) => {
    const { botId } = connection;
  ...
  const saveGroupResponseMode = React14.useCallback(async (connection, groupResponseMode) => {
    const { botId } = connection;
...
function TelegramAccessSettings({ account, busy = false, onSave }) {
  ...
  const accessHelpId = React18.useId();
  const [accessMode, setAccessMode] = React18.useState(policy.accessMode);
  const [allowedUsers, setAllowedUsers] = React18.useState(sourceUsers);
...
function WhatsappAccessSettings({ account, busy = false, onSave }) {
  ...
  const helpId = React21.useId();
  const [accessMode, setAccessMode] = React21.useState(policy.accessMode);
  const [allowedNumbers, setAllowedNumbers] = React21.useState(sourceNumbers);
